...
from ..entities.m18_00_00_00_entities import Characters as m18_00_Characters, Boxes as m18_00_Boxes
...
@RestartOnRest
def PatchesAmbush():
    """ 11022000: Patches teleports behind the player and attacks. """
    DisableCharacter(Characters.c0000_PatchesAmbush)

    Await(InsideMap(FIRELINK_SHRINE) and TriggerFlags.PatchesAmbush and IsAlive(Characters.c0000_PatchesAmbush))
...
@RestartOnRest
def ChannelerAmbush():
    """ 11022001: Channeler teleports above the player (no gravity) and uses its buff dance. """
    DisableCharacter(Characters.c2370_TrollChanneler)

    Await(InsideMap(FIRELINK_SHRINE) and TriggerFlags.ChannelerAmbush and IsAlive(Characters.c2370_TrollChanneler))
    ...
    AddSpecialEffect(6261, 5470)
    AddSpecialEffect(6031, 5470)
    AddSpecialEffect(6041, 5470)
    AddSpecialEffect(6070, 5470)
    AddSpecialEffect(6080, 5470)
    AddSpecialEffect(6090, 5470)
    AddSpecialEffect(6100, 5470)
    AddSpecialEffect(6131, 5470)
    AddSpecialEffect(6270, 5470)
    AddSpecialEffect(6301, 5470)
    AddSpecialEffect(6287, 5470)
    AddSpecialEffect(6292, 5470)
    AddSpecialEffect(6322, 5470)
    AddSpecialEffect(6181, 5470)
    AddSpecialEffect(1020960, 5470)
    AddSpecialEffect(1020207, 5470)
    AddSpecialEffect(6450, 5470)
    AddSpecialEffect(1020208, 5470)
    AddSpecialEffect(6240, 5470)
    AddSpecialEffect(1020160, 5470)
    AddSpecialEffect(1020161, 5470)
    AddSpecialEffect(1020163, 5470)
    AddSpecialEffect(1020165, 5470)
    AddSpecialEffect(1020166, 5470)
    AddSpecialEffect(1020190, 5470)
    AddSpecialEffect(6060, 5470)
    AddSpecialEffect(1020200, 5470)
    AddSpecialEffect(1020201, 5470)
    AddSpecialEffect(1020202, 5470)
    AddSpecialEffect(1020203, 5470)
    AddSpecialEffect(1020204, 5470)
    AddSpecialEffect(1020205, 5470)
    AddSpecialEffect(1020206, 5470)
    AddSpecialEffect(1020209, 5470)
    AddSpecialEffect(1020210, 5470)
    AddSpecialEffect(1020211, 5470)
    AddSpecialEffect(1020214, 5470)
    AddSpecialEffect(1020212, 5470)
    AddSpecialEffect(1020213, 5470)
    AddSpecialEffect(1020100, 5470)
    AddSpecialEffect(6330, 5470)
...
def RedPhantomAmbush():
    """ 11022002: No phantoms in this map, so it acts as an extra Patches trigger. """
    Await(InsideMap(FIRELINK_SHRINE) and TriggerFlags.EnemyAmbush)
...
def ControlRedPhantom(_, enemy: int):
    """ 11025081: `enemy` moves to player and appears. """
    DisableFlag(11025082)
...
@RestartOnRest
def OopsAllGwyns():
    """ 11022004: Enable Gwyns and warp them to their paired normal characters. """
    DisableCharacter(1020600)
    DisableCharacter(1020601)
    DisableCharacter(1020602)
    DisableCharacter(1020603)
    DisableCharacter(1020604)
    DisableCharacter(1020605)
    DisableCharacter(1020606)
    DisableCharacter(1020607)
    Await(TriggerFlags.OopsAllGwyns)  # note you don't need to be standing in the map
    DisableCharacter(6261)
    EnableCharacter(1020600)
    DisableCharacter(6090)
    EnableCharacter(1020601)
    DisableCharacter(6287)
    EnableCharacter(1020602)
    DisableCharacter(1020161)
    EnableCharacter(1020603)
    DisableCharacter(6060)
    EnableCharacter(1020604)
    DisableCharacter(1020204)
    EnableCharacter(1020605)
    DisableCharacter(1020211)
    EnableCharacter(1020606)
    DisableCharacter(6330)
    EnableCharacter(1020607)
...
def OopsAllBonewheels():
    """ 11022005: Enable Bonewheels and warp them to their paired normal characters. """
    DisableCharacter(1020400)
    DisableCharacter(1020401)
    DisableCharacter(1020402)
    DisableCharacter(1020403)
    DisableCharacter(1020404)
    DisableCharacter(1020405)
    DisableCharacter(1020406)
    DisableCharacter(1020407)
    DisableCharacter(1020408)
    DisableCharacter(1020409)
    DisableCharacter(1020410)
    DisableCharacter(1020411)
    DisableCharacter(1020412)
    DisableCharacter(1020413)
    DisableCharacter(1020414)
    DisableCharacter(1020415)
    DisableCharacter(1020416)
    DisableCharacter(1020417)
    DisableCharacter(1020418)
    DisableCharacter(1020419)
    DisableCharacter(1020420)
    DisableCharacter(1020421)
    DisableCharacter(1020422)
    DisableCharacter(1020423)
    DisableCharacter(1020424)
    DisableCharacter(1020425)
    DisableCharacter(1020426)
    DisableCharacter(1020427)
    DisableCharacter(1020428)
    DisableCharacter(1020429)
    DisableCharacter(1020430)
    DisableCharacter(1020431)
    DisableCharacter(1020432)
    DisableCharacter(1020433)
    DisableCharacter(1020434)
    DisableCharacter(1020435)
    DisableCharacter(1020436)
    DisableCharacter(1020437)
    Await(TriggerFlags.OopsAllBonewheels)  # note you don't need to be standing in the map
    DisableCharacter(6261)
    EnableCharacter(1020400)
    DisableCharacter(6031)
    EnableCharacter(1020401)
    DisableCharacter(6041)
    EnableCharacter(1020402)
    DisableCharacter(6070)
    EnableCharacter(1020403)
    DisableCharacter(6080)
    EnableCharacter(1020404)
    DisableCharacter(6090)
    EnableCharacter(1020405)
    DisableCharacter(6100)
    EnableCharacter(1020406)
    DisableCharacter(6131)
    EnableCharacter(1020407)
    DisableCharacter(6270)
    EnableCharacter(1020408)
    DisableCharacter(6301)
    EnableCharacter(1020409)
    DisableCharacter(6287)
    EnableCharacter(1020410)
    DisableCharacter(6292)
    EnableCharacter(1020411)
    DisableCharacter(6322)
    EnableCharacter(1020412)
    DisableCharacter(6181)
    EnableCharacter(1020413)
    DisableCharacter(1020208)
    EnableCharacter(1020414)
    DisableCharacter(6240)
    EnableCharacter(1020415)
    DisableCharacter(1020160)
    EnableCharacter(1020416)
    DisableCharacter(1020161)
    EnableCharacter(1020417)
    DisableCharacter(1020163)
    EnableCharacter(1020418)
    DisableCharacter(1020165)
    EnableCharacter(1020419)
    DisableCharacter(1020166)
    EnableCharacter(1020420)
    DisableCharacter(1020190)
    EnableCharacter(1020421)
    DisableCharacter(6060)
    EnableCharacter(1020422)
    DisableCharacter(1020200)
    EnableCharacter(1020423)
    DisableCharacter(1020201)
    EnableCharacter(1020424)
    DisableCharacter(1020202)
    EnableCharacter(1020425)
    DisableCharacter(1020203)
    EnableCharacter(1020426)
    DisableCharacter(1020204)
    EnableCharacter(1020427)
    DisableCharacter(1020205)
    EnableCharacter(1020428)
    DisableCharacter(1020206)
    EnableCharacter(1020429)
    DisableCharacter(1020209)
    EnableCharacter(1020430)
    DisableCharacter(1020210)
    EnableCharacter(1020431)
    DisableCharacter(1020211)
    EnableCharacter(1020432)
    DisableCharacter(1020214)
    EnableCharacter(1020433)
    DisableCharacter(1020212)
    EnableCharacter(1020434)
    DisableCharacter(1020213)
    EnableCharacter(1020435)
    DisableCharacter(1020100)
    EnableCharacter(1020436)
    DisableCharacter(6330)
    EnableCharacter(1020437)
    WaitFrames(30)  # enough time for other maps to trigger too
...
@RestartOnRest
def HyperAggression():
    """ 11022006: Switch AI param of every enemy to its aggressive version. """
    Await(TriggerFlags.HyperAggression or TriggerFlags.HyperAggressionReTrigger)
    
    SetAIParamID(1020208, 120150)
    SetAIParamID(1020160, 254058)
    SetAIParamID(1020161, 254060)
    SetAIParamID(1020163, 254061)
    SetAIParamID(1020165, 254059)
    SetAIParamID(1020166, 254061)
    SetAIParamID(1020190, 255058)
    SetAIParamID(1020200, 290053)
    SetAIParamID(1020201, 290053)
    SetAIParamID(1020202, 290053)
    SetAIParamID(1020203, 290054)
    SetAIParamID(1020204, 290053)
    SetAIParamID(1020205, 290054)
    SetAIParamID(1020206, 290053)
    SetAIParamID(1020209, 290054)
    SetAIParamID(1020210, 290053)
    SetAIParamID(1020211, 290053)
    SetAIParamID(1020214, 290053)
    SetAIParamID(1020212, 291052)
    SetAIParamID(1020213, 291052)
    SetAIParamID(1020100, 351050)
    SetAIParamID(1020600, 537050)
    SetAIParamID(1020601, 537050)
    SetAIParamID(1020602, 537050)
    SetAIParamID(1020603, 537050)
    SetAIParamID(1020604, 537050)
    SetAIParamID(1020605, 537050)
    SetAIParamID(1020606, 537050)
    SetAIParamID(1020607, 537050)
    SetAIParamID(1020400, 293050)
    SetAIParamID(1020401, 293050)
    SetAIParamID(1020402, 293050)
    SetAIParamID(1020403, 293050)
    SetAIParamID(1020404, 293050)
    SetAIParamID(1020405, 293050)
    SetAIParamID(1020406, 293050)
    SetAIParamID(1020407, 293050)
    SetAIParamID(1020408, 293050)
    SetAIParamID(1020409, 293050)
    SetAIParamID(1020410, 293050)
    SetAIParamID(1020411, 293050)
    SetAIParamID(1020412, 293050)
    SetAIParamID(1020413, 293050)
    SetAIParamID(1020414, 293050)
    SetAIParamID(1020415, 293050)
    SetAIParamID(1020416, 293050)
    SetAIParamID(1020417, 293050)
    SetAIParamID(1020418, 293050)
    SetAIParamID(1020419, 293050)
    SetAIParamID(1020420, 293050)
    SetAIParamID(1020421, 293050)
    SetAIParamID(1020422, 293050)
    SetAIParamID(1020423, 293050)
    SetAIParamID(1020424, 293050)
    SetAIParamID(1020425, 293050)
    SetAIParamID(1020426, 293050)
    SetAIParamID(1020427, 293050)
    SetAIParamID(1020428, 293050)
    SetAIParamID(1020429, 293050)
    SetAIParamID(1020430, 293050)
    SetAIParamID(1020431, 293050)
    SetAIParamID(1020432, 293050)
    SetAIParamID(1020433, 293050)
    SetAIParamID(1020434, 293050)
    SetAIParamID(1020435, 293050)
    SetAIParamID(1020436, 293050)
    SetAIParamID(1020437, 293050)
        
    # Common EMEVD manages the flags that control this event.
    Await(not TriggerFlags.HyperAggressionReTrigger)
    
    SetAIParamID(1020208, 120100)
    SetAIParamID(1020160, 254008)
    SetAIParamID(1020161, 254010)
    SetAIParamID(1020163, 254011)
    SetAIParamID(1020165, 254009)
    SetAIParamID(1020166, 254011)
    SetAIParamID(1020190, 255008)
    SetAIParamID(1020200, 290003)
    SetAIParamID(1020201, 290003)
    SetAIParamID(1020202, 290003)
    SetAIParamID(1020203, 290004)
    SetAIParamID(1020204, 290003)
    SetAIParamID(1020205, 290004)
    SetAIParamID(1020206, 290003)
    SetAIParamID(1020209, 290004)
    SetAIParamID(1020210, 290003)
    SetAIParamID(1020211, 290003)
    SetAIParamID(1020214, 290003)
    SetAIParamID(1020212, 291002)
    SetAIParamID(1020213, 291002)
    SetAIParamID(1020100, 351000)
    SetAIParamID(1020600, 537000)
    SetAIParamID(1020601, 537000)
    SetAIParamID(1020602, 537000)
    SetAIParamID(1020603, 537000)
    SetAIParamID(1020604, 537000)
    SetAIParamID(1020605, 537000)
    SetAIParamID(1020606, 537000)
    SetAIParamID(1020607, 537000)
    SetAIParamID(1020400, 293000)
    SetAIParamID(1020401, 293000)
    SetAIParamID(1020402, 293000)
    SetAIParamID(1020403, 293000)
    SetAIParamID(1020404, 293000)
    SetAIParamID(1020405, 293000)
    SetAIParamID(1020406, 293000)
    SetAIParamID(1020407, 293000)
    SetAIParamID(1020408, 293000)
    SetAIParamID(1020409, 293000)
    SetAIParamID(1020410, 293000)
    SetAIParamID(1020411, 293000)
    SetAIParamID(1020412, 293000)
    SetAIParamID(1020413, 293000)
    SetAIParamID(1020414, 293000)
    SetAIParamID(1020415, 293000)
    SetAIParamID(1020416, 293000)
    SetAIParamID(1020417, 293000)
    SetAIParamID(1020418, 293000)
    SetAIParamID(1020419, 293000)
    SetAIParamID(1020420, 293000)
    SetAIParamID(1020421, 293000)
    SetAIParamID(1020422, 293000)
    SetAIParamID(1020423, 293000)
    SetAIParamID(1020424, 293000)
    SetAIParamID(1020425, 293000)
    SetAIParamID(1020426, 293000)
    SetAIParamID(1020427, 293000)
    SetAIParamID(1020428, 293000)
    SetAIParamID(1020429, 293000)
    SetAIParamID(1020430, 293000)
    SetAIParamID(1020431, 293000)
    SetAIParamID(1020432, 293000)
    SetAIParamID(1020433, 293000)
    SetAIParamID(1020434, 293000)
    SetAIParamID(1020435, 293000)
    SetAIParamID(1020436, 293000)
    SetAIParamID(1020437, 293000)
...
@RestartOnRest
def EnemySpeedUp():
    """ 11022200: Temporary enemy effect. """
    Await(TriggerFlags.EnemySpeedUp)
    AddSpecialEffect(6261, 200000)
    AddSpecialEffect(6031, 200000)
    AddSpecialEffect(6041, 200000)
    AddSpecialEffect(6070, 200000)
    AddSpecialEffect(6080, 200000)
    AddSpecialEffect(6090, 200000)
    AddSpecialEffect(6100, 200000)
    AddSpecialEffect(6131, 200000)
    AddSpecialEffect(6270, 200000)
    AddSpecialEffect(6301, 200000)
    AddSpecialEffect(6287, 200000)
    AddSpecialEffect(6292, 200000)
    AddSpecialEffect(6322, 200000)
    AddSpecialEffect(6181, 200000)
    AddSpecialEffect(1020960, 200000)
    AddSpecialEffect(1020207, 200000)
    AddSpecialEffect(6450, 200000)
    AddSpecialEffect(1020208, 200000)
    AddSpecialEffect(6240, 200000)
    AddSpecialEffect(1020160, 200000)
    AddSpecialEffect(1020161, 200000)
    AddSpecialEffect(1020163, 200000)
    AddSpecialEffect(1020165, 200000)
    AddSpecialEffect(1020166, 200000)
    AddSpecialEffect(1020190, 200000)
    AddSpecialEffect(6060, 200000)
    AddSpecialEffect(1020200, 200000)
    AddSpecialEffect(1020201, 200000)
    AddSpecialEffect(1020202, 200000)
    AddSpecialEffect(1020203, 200000)
    AddSpecialEffect(1020204, 200000)
    AddSpecialEffect(1020205, 200000)
    AddSpecialEffect(1020206, 200000)
    AddSpecialEffect(1020209, 200000)
    AddSpecialEffect(1020210, 200000)
    AddSpecialEffect(1020211, 200000)
    AddSpecialEffect(1020214, 200000)
    AddSpecialEffect(1020212, 200000)
    AddSpecialEffect(1020213, 200000)
    AddSpecialEffect(1020100, 200000)
    AddSpecialEffect(6330, 200000)
...
def EnemyExtremeSpeedUp():
    """ 11022201: Temporary enemy effect. """
    Await(TriggerFlags.EnemyExtremeSpeedUp)
    AddSpecialEffect(6261, 200001)
    AddSpecialEffect(6031, 200001)
    AddSpecialEffect(6041, 200001)
    AddSpecialEffect(6070, 200001)
    AddSpecialEffect(6080, 200001)
    AddSpecialEffect(6090, 200001)
    AddSpecialEffect(6100, 200001)
    AddSpecialEffect(6131, 200001)
    AddSpecialEffect(6270, 200001)
    AddSpecialEffect(6301, 200001)
    AddSpecialEffect(6287, 200001)
    AddSpecialEffect(6292, 200001)
    AddSpecialEffect(6322, 200001)
    AddSpecialEffect(6181, 200001)
    AddSpecialEffect(1020960, 200001)
    AddSpecialEffect(1020207, 200001)
    AddSpecialEffect(6450, 200001)
    AddSpecialEffect(1020208, 200001)
    AddSpecialEffect(6240, 200001)
    AddSpecialEffect(1020160, 200001)
    AddSpecialEffect(1020161, 200001)
    AddSpecialEffect(1020163, 200001)
    AddSpecialEffect(1020165, 200001)
    AddSpecialEffect(1020166, 200001)
    AddSpecialEffect(1020190, 200001)
    AddSpecialEffect(6060, 200001)
    AddSpecialEffect(1020200, 200001)
    AddSpecialEffect(1020201, 200001)
    AddSpecialEffect(1020202, 200001)
    AddSpecialEffect(1020203, 200001)
    AddSpecialEffect(1020204, 200001)
    AddSpecialEffect(1020205, 200001)
    AddSpecialEffect(1020206, 200001)
    AddSpecialEffect(1020209, 200001)
    AddSpecialEffect(1020210, 200001)
    AddSpecialEffect(1020211, 200001)
    AddSpecialEffect(1020214, 200001)
    AddSpecialEffect(1020212, 200001)
    AddSpecialEffect(1020213, 200001)
    AddSpecialEffect(1020100, 200001)
    AddSpecialEffect(6330, 200001)
    WaitFrames(10)  # give other loaded maps time to trigger
...
@RestartOnRest
def EnemySpeedDown():
    """ 11022202: Temporary enemy effect. """
    Await(TriggerFlags.EnemySpeedDown)
    AddSpecialEffect(6261, 200002)
    AddSpecialEffect(6031, 200002)
    AddSpecialEffect(6041, 200002)
    AddSpecialEffect(6070, 200002)
    AddSpecialEffect(6080, 200002)
    AddSpecialEffect(6090, 200002)
    AddSpecialEffect(6100, 200002)
    AddSpecialEffect(6131, 200002)
    AddSpecialEffect(6270, 200002)
    AddSpecialEffect(6301, 200002)
    AddSpecialEffect(6287, 200002)
    AddSpecialEffect(6292, 200002)
    AddSpecialEffect(6322, 200002)
    AddSpecialEffect(6181, 200002)
    AddSpecialEffect(1020960, 200002)
    AddSpecialEffect(1020207, 200002)
    AddSpecialEffect(6450, 200002)
    AddSpecialEffect(1020208, 200002)
    AddSpecialEffect(6240, 200002)
    AddSpecialEffect(1020160, 200002)
    AddSpecialEffect(1020161, 200002)
    AddSpecialEffect(1020163, 200002)
    AddSpecialEffect(1020165, 200002)
    AddSpecialEffect(1020166, 200002)
    AddSpecialEffect(1020190, 200002)
    AddSpecialEffect(6060, 200002)
    AddSpecialEffect(1020200, 200002)
    AddSpecialEffect(1020201, 200002)
    AddSpecialEffect(1020202, 200002)
    AddSpecialEffect(1020203, 200002)
    AddSpecialEffect(1020204, 200002)
    AddSpecialEffect(1020205, 200002)
    AddSpecialEffect(1020206, 200002)
    AddSpecialEffect(1020209, 200002)
    AddSpecialEffect(1020210, 200002)
    AddSpecialEffect(1020211, 200002)
    AddSpecialEffect(1020214, 200002)
    AddSpecialEffect(1020212, 200002)
    AddSpecialEffect(1020213, 200002)
    AddSpecialEffect(1020100, 200002)
    AddSpecialEffect(6330, 200002)
    WaitFrames(10)  # give other loaded maps time to trigger
...
def EnemyExtremeSpeedDown():
    """ 11022203: Temporary enemy effect. """
    Await(TriggerFlags.EnemyExtremeSpeedDown)
    AddSpecialEffect(6261, 200003)
    AddSpecialEffect(6031, 200003)
    AddSpecialEffect(6041, 200003)
    AddSpecialEffect(6070, 200003)
    AddSpecialEffect(6080, 200003)
    AddSpecialEffect(6090, 200003)
    AddSpecialEffect(6100, 200003)
    AddSpecialEffect(6131, 200003)
    AddSpecialEffect(6270, 200003)
    AddSpecialEffect(6301, 200003)
    AddSpecialEffect(6287, 200003)
    AddSpecialEffect(6292, 200003)
    AddSpecialEffect(6322, 200003)
    AddSpecialEffect(6181, 200003)
    AddSpecialEffect(1020960, 200003)
    AddSpecialEffect(1020207, 200003)
    AddSpecialEffect(6450, 200003)
    AddSpecialEffect(1020208, 200003)
    AddSpecialEffect(6240, 200003)
    AddSpecialEffect(1020160, 200003)
    AddSpecialEffect(1020161, 200003)
    AddSpecialEffect(1020163, 200003)
    AddSpecialEffect(1020165, 200003)
    AddSpecialEffect(1020166, 200003)
    AddSpecialEffect(1020190, 200003)
    AddSpecialEffect(6060, 200003)
    AddSpecialEffect(1020200, 200003)
    AddSpecialEffect(1020201, 200003)
    AddSpecialEffect(1020202, 200003)
    AddSpecialEffect(1020203, 200003)
    AddSpecialEffect(1020204, 200003)
    AddSpecialEffect(1020205, 200003)
    AddSpecialEffect(1020206, 200003)
    AddSpecialEffect(1020209, 200003)
    AddSpecialEffect(1020210, 200003)
    AddSpecialEffect(1020211, 200003)
    AddSpecialEffect(1020214, 200003)
    AddSpecialEffect(1020212, 200003)
    AddSpecialEffect(1020213, 200003)
    AddSpecialEffect(1020100, 200003)
    AddSpecialEffect(6330, 200003)
    WaitFrames(10)  # give other loaded maps time to trigger
...
def EnemyHealthRegain():
    """ 11022204: Temporary enemy effect. """
    Await(TriggerFlags.EnemyHealthRegain)
    AddSpecialEffect(6261, 200004)
    AddSpecialEffect(6031, 200004)
    AddSpecialEffect(6041, 200004)
    AddSpecialEffect(6070, 200004)
    AddSpecialEffect(6080, 200004)
    AddSpecialEffect(6090, 200004)
    AddSpecialEffect(6100, 200004)
    AddSpecialEffect(6131, 200004)
    AddSpecialEffect(6270, 200004)
    AddSpecialEffect(6301, 200004)
    AddSpecialEffect(6287, 200004)
    AddSpecialEffect(6292, 200004)
    AddSpecialEffect(6322, 200004)
    AddSpecialEffect(6181, 200004)
    AddSpecialEffect(1020960, 200004)
    AddSpecialEffect(1020207, 200004)
    AddSpecialEffect(6450, 200004)
    AddSpecialEffect(1020208, 200004)
    AddSpecialEffect(6240, 200004)
    AddSpecialEffect(1020160, 200004)
    AddSpecialEffect(1020161, 200004)
    AddSpecialEffect(1020163, 200004)
    AddSpecialEffect(1020165, 200004)
    AddSpecialEffect(1020166, 200004)
    AddSpecialEffect(1020190, 200004)
    AddSpecialEffect(6060, 200004)
    AddSpecialEffect(1020200, 200004)
    AddSpecialEffect(1020201, 200004)
    AddSpecialEffect(1020202, 200004)
    AddSpecialEffect(1020203, 200004)
    AddSpecialEffect(1020204, 200004)
    AddSpecialEffect(1020205, 200004)
    AddSpecialEffect(1020206, 200004)
    AddSpecialEffect(1020209, 200004)
    AddSpecialEffect(1020210, 200004)
    AddSpecialEffect(1020211, 200004)
    AddSpecialEffect(1020214, 200004)
    AddSpecialEffect(1020212, 200004)
    AddSpecialEffect(1020213, 200004)
    AddSpecialEffect(1020100, 200004)
    AddSpecialEffect(6330, 200004)
    WaitFrames(10)  # give other loaded maps time to trigger
...
def EnemyMaxHealthUp():
    """ 11022205: Temporary enemy effect. """
    Await(TriggerFlags.EnemyMaxHealthUp)
    AddSpecialEffect(6261, 200005)
    AddSpecialEffect(6031, 200005)
    AddSpecialEffect(6041, 200005)
    AddSpecialEffect(6070, 200005)
    AddSpecialEffect(6080, 200005)
    AddSpecialEffect(6090, 200005)
    AddSpecialEffect(6100, 200005)
    AddSpecialEffect(6131, 200005)
    AddSpecialEffect(6270, 200005)
    AddSpecialEffect(6301, 200005)
    AddSpecialEffect(6287, 200005)
    AddSpecialEffect(6292, 200005)
    AddSpecialEffect(6322, 200005)
    AddSpecialEffect(6181, 200005)
    AddSpecialEffect(1020960, 200005)
    AddSpecialEffect(1020207, 200005)
    AddSpecialEffect(6450, 200005)
    AddSpecialEffect(1020208, 200005)
    AddSpecialEffect(6240, 200005)
    AddSpecialEffect(1020160, 200005)
    AddSpecialEffect(1020161, 200005)
    AddSpecialEffect(1020163, 200005)
    AddSpecialEffect(1020165, 200005)
    AddSpecialEffect(1020166, 200005)
    AddSpecialEffect(1020190, 200005)
    AddSpecialEffect(6060, 200005)
    AddSpecialEffect(1020200, 200005)
    AddSpecialEffect(1020201, 200005)
    AddSpecialEffect(1020202, 200005)
    AddSpecialEffect(1020203, 200005)
    AddSpecialEffect(1020204, 200005)
    AddSpecialEffect(1020205, 200005)
    AddSpecialEffect(1020206, 200005)
    AddSpecialEffect(1020209, 200005)
    AddSpecialEffect(1020210, 200005)
    AddSpecialEffect(1020211, 200005)
    AddSpecialEffect(1020214, 200005)
    AddSpecialEffect(1020212, 200005)
    AddSpecialEffect(1020213, 200005)
    AddSpecialEffect(1020100, 200005)
    AddSpecialEffect(6330, 200005)
    WaitFrames(10)  # give other loaded maps time to trigger
...
def EnemyMaxHealthDown():
    """ 11022206: Temporary enemy effect. """
    Await(TriggerFlags.EnemyMaxHealthDown)
    AddSpecialEffect(6261, 200006)
    AddSpecialEffect(6031, 200006)
    AddSpecialEffect(6041, 200006)
    AddSpecialEffect(6070, 200006)
    AddSpecialEffect(6080, 200006)
    AddSpecialEffect(6090, 200006)
    AddSpecialEffect(6100, 200006)
    AddSpecialEffect(6131, 200006)
    AddSpecialEffect(6270, 200006)
    AddSpecialEffect(6301, 200006)
    AddSpecialEffect(6287, 200006)
    AddSpecialEffect(6292, 200006)
    AddSpecialEffect(6322, 200006)
    AddSpecialEffect(6181, 200006)
    AddSpecialEffect(1020960, 200006)
    AddSpecialEffect(1020207, 200006)
    AddSpecialEffect(6450, 200006)
    AddSpecialEffect(1020208, 200006)
    AddSpecialEffect(6240, 200006)
    AddSpecialEffect(1020160, 200006)
    AddSpecialEffect(1020161, 200006)
    AddSpecialEffect(1020163, 200006)
    AddSpecialEffect(1020165, 200006)
    AddSpecialEffect(1020166, 200006)
    AddSpecialEffect(1020190, 200006)
    AddSpecialEffect(6060, 200006)
    AddSpecialEffect(1020200, 200006)
    AddSpecialEffect(1020201, 200006)
    AddSpecialEffect(1020202, 200006)
    AddSpecialEffect(1020203, 200006)
    AddSpecialEffect(1020204, 200006)
    AddSpecialEffect(1020205, 200006)
    AddSpecialEffect(1020206, 200006)
    AddSpecialEffect(1020209, 200006)
    AddSpecialEffect(1020210, 200006)
    AddSpecialEffect(1020211, 200006)
    AddSpecialEffect(1020214, 200006)
    AddSpecialEffect(1020212, 200006)
    AddSpecialEffect(1020213, 200006)
    AddSpecialEffect(1020100, 200006)
    AddSpecialEffect(6330, 200006)
    WaitFrames(10)  # give other loaded maps time to trigger
...
@RestartOnRest
def EnemyDefenseUp():
    """ 11022207: Temporary enemy effect. """
    Await(TriggerFlags.EnemyDefenseUp)
    AddSpecialEffect(6261, 200007)
    AddSpecialEffect(6031, 200007)
    AddSpecialEffect(6041, 200007)
    AddSpecialEffect(6070, 200007)
    AddSpecialEffect(6080, 200007)
    AddSpecialEffect(6090, 200007)
    AddSpecialEffect(6100, 200007)
    AddSpecialEffect(6131, 200007)
    AddSpecialEffect(6270, 200007)
    AddSpecialEffect(6301, 200007)
    AddSpecialEffect(6287, 200007)
    AddSpecialEffect(6292, 200007)
    AddSpecialEffect(6322, 200007)
    AddSpecialEffect(6181, 200007)
    AddSpecialEffect(1020960, 200007)
    AddSpecialEffect(1020207, 200007)
    AddSpecialEffect(6450, 200007)
    AddSpecialEffect(1020208, 200007)
    AddSpecialEffect(6240, 200007)
    AddSpecialEffect(1020160, 200007)
    AddSpecialEffect(1020161, 200007)
    AddSpecialEffect(1020163, 200007)
    AddSpecialEffect(1020165, 200007)
    AddSpecialEffect(1020166, 200007)
    AddSpecialEffect(1020190, 200007)
    AddSpecialEffect(6060, 200007)
    AddSpecialEffect(1020200, 200007)
    AddSpecialEffect(1020201, 200007)
    AddSpecialEffect(1020202, 200007)
    AddSpecialEffect(1020203, 200007)
    AddSpecialEffect(1020204, 200007)
    AddSpecialEffect(1020205, 200007)
    AddSpecialEffect(1020206, 200007)
    AddSpecialEffect(1020209, 200007)
    AddSpecialEffect(1020210, 200007)
    AddSpecialEffect(1020211, 200007)
    AddSpecialEffect(1020214, 200007)
    AddSpecialEffect(1020212, 200007)
    AddSpecialEffect(1020213, 200007)
    AddSpecialEffect(1020100, 200007)
    AddSpecialEffect(6330, 200007)
    WaitFrames(10)  # give other loaded maps time to trigger
