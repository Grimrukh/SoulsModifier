"""Manus bonfire. Always allows warping."""
...
class State_4(State):
    ...
    def enter(self):
        ...
        AddTalkListData(menu_index=7, menu_text=15000150, required_flag=-1)  # warp menu does not require flag 710
    ...
    def test(self):
        ...
        if GetTalkListEntryResult() == 12:
            return State_31
        if GetTalkListEntryResult() == 7:  # never goes to `State_67` (does not check flag 706)
            return State_31
